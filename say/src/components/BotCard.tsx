...
const BotCard: React.FC<BotCardProps> = ({ bot }) => {
	return (
		<div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg hover:scale-105 transition-all duration-300 mb-4">
			<img className="w-full h-40 object-cover rounded-t-md" src={bot.imageUrl} alt={bot.name} />
